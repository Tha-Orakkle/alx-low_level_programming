...
practicing how to write Makefiles.

## Helper Files

* [school.c](./school.c): C function that displays a seahorse(The holberton school logo) in text.
Only used for the purpose of practices.

* [main.c](./main.c): Main C function that calls the function defined in
[school.c](./school.c).

## Header File :file_folder:

* [m.h](./m.h): Header file - contains function prototype used in `school.c`.
